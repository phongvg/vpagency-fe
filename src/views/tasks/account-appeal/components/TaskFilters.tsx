...
import { AccountAppealStatus } from '../types/accountAppeal.type'

const statusLabels = {
  [AccountAppealStatus.PENDING]: 'Chờ xử lý',
  [AccountAppealStatus.IN_PROGRESS]: 'Đang xử lý',
  [AccountAppealStatus.COMPLETED]: 'Hoàn thành',
  [AccountAppealStatus.CANCELLED]: 'Đã hủy',
}

const statusOptions = [
  { value: '', label: 'Tất cả trạng thái' },
  ...Object.values(AccountAppealStatus).map((status) => ({
    value: status,
...
export default function TaskFilters() {
  const { filters, setFilters } = useAccountAppealStore()
