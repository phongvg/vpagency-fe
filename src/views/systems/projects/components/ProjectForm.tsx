...
import { useCreateProjectMutation, useUpdateProjectMutation } from '@/views/systems/projects/hooks/useProjectsQueries'
          ...
          <FormContainer>
            ...
            <div className="mb-7">
              <div className="gap-4 grid grid-cols-2">
                ...
                <FormItem label="Từ khóa bị từ chối" className="mb-0" asterisk>
                  <Field
                    name="rejectedKeywords"
                    placeholder="Nhập từ khóa bị từ chối..."
                    component={Textarea}
                    rows={3}
                    onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => {
                      const keywords = e.target.value
            ...
            <div className="mb-7">
              <div className="gap-4 grid grid-cols-2">
                <FormItem label="Quốc gia mục tiêu" className="mb-0" asterisk>
                  <Field
                    name="targetCountries"
                    placeholder="Nhập quốc gia mục tiêu..."
                    component={Textarea}
                    rows={3}
                    onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => {
                ...
                <FormItem label="Quốc gia loại" className="mb-0" asterisk>
                  <Field
                    name="rejectedCountries"
                    placeholder="Nhập quốc gia loại..."
                    component={Textarea}
                    rows={3}
                    onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => {
                      const countries = e.target.value
