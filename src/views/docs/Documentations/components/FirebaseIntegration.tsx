  ...
  return (
    <>
      <p>
        ...
        applications. It offers various tools and services such as
        authentication, real-time database, cloud storage, hosting, and more,
        which known as a backend as service.
      </p>
      <p>
        While our template doesn't have Firebase integration pre-built, we've
        noticed a high demand from our customers for it. As a result, we've put
        together a straightforward auth integration tutorial to help you
        ...
        <ul className="mt-1">
          <li>
            ...
            <ol>
              ...
              <li>
                Once the project is created, click on the "Web" option to add a
                web app to your project.
              </li>
              <li>
                Follow the instructions to register the app and obtain the
      ...
      <div className="mt-10" id="initialize-firebase">
        ...
        <ul>
          <li>
            <p>
              In your template directory, go ahead and create a file named{' '}
              <code>firebase.config.ts</code> within the <code>/configs</code>{' '}
              directory. Put your Firebase configuration details in this file
              (you can find this information in your Firebase account). It's
              best practice to store these values in a <code>.env</code> file.
            </p>
...
export default firebaseConfig`}</SyntaxHighlighter>
          ...
          <li>
            <p>
              Create a Firebase entry in your <code>/src</code> directory. You
              can do this by adding a file named firebase.ts
            </p>
    ...
    createUserWithEmailAndPassword
      ...
      <div className="mt-10" id="integrating-firebase">
        ...
        <ul>
          <li>
            <p>
              Open <code>AuthService.ts</code> under <code>/services</code>{' '}
    ...
    return await signOut(auth).then(user => user).catch(err => err);
          ...
          <li>
            <p>
              ...
              <code>username</code> as a credential, you'll need to make
              adjustments to the input and schema in <code>SignInForm.tsx</code>
              , <code>SignUpForm.tsx</code> & <code>@types/auth.ts</code>.
              Below, you'll find the updated code that you can use to replace
              them.
            </p>
...
const SignUpForm = (props: SignUpFormProps) => {
    ...
    return (
      ...
      <div className="mt-10" id="conclusion">
        <h5>Conclusion</h5>
        <p>
          By following these steps, you have successfully integrated Firebase
          SDK auth with to the template. You can leverage the powerful features
          offered by Firebase to enhance the functionality and user experience
          along with Elstar.
        </p>
        <p>
