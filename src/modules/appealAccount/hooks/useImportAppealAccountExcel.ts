...
interface UseImportAppealAccountExcelReturn {
...
export const useImportAppealAccountExcel = (): UseImportAppealAccountExcelReturn => {
  ...
  const processFile = useCallback((file: File): Promise<UpdateAppealAccountRequest[]> => {
    return new Promise((resolve, reject) => {
      ...
      const worker = new Worker(new URL("../workers/importAppealAccountWorker.ts", import.meta.url), {
        type: "module",
      });
