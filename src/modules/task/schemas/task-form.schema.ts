...
export const taskFormSchema = z
  .object({
    ...
    deadline: z.date({ error: "Ngày deadline không được bỏ trống" }),
    assignedUserIds: z.array(z.object({ value: z.string(), label: z.string() })).min(1, "Phải có ít nhất một người nhận việc"),
    projectId: z.object({ value: z.string(), label: z.string() }).nullable().optional(),
