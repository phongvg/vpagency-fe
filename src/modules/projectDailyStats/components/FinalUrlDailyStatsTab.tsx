...
import FinalUrlDailyStatsTable from "@/modules/projectDailyStats/components/FinalUrlDailyStatsTable";
    ...
    <div className='space-y-4'>
      ...
      <Card>
        ...
        <CardContent className='normal-case'>
          <FinalUrlDailySummaryTable summary={finalUrlDailyStats?.data?.summary} loading={isLoading} />
        </CardContent>
      </Card>

      <FinalUrlDailyStatsTable data={finalUrlDailyStats} loading={isLoading} params={params} setParams={setParams} />
    </div>
  );
}
