...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex items-center focus:bg-accent data-[disabled]:opacity-50 py-1.5 pr-2 pl-8 rounded-sm outline-none text-sm transition-colors focus:text-accent-foreground cursor-pointer data-[disabled]:pointer-events-none select-none",
      className
    )}
    checked={checked}
    {...props}>
